...
public class User_Tests2 {
    ...
    public void testPostUser(){
        ...
        Response response = User_endpoints2.create_User(user_payload);
    ...
    public void testGetUser() {
        ...
        Response response = User_endpoints2.read_User(this.user_payload.getUsername());
        response.then().log().all();
        Assert.assertEquals(response.getStatusCode(), 200);
    }
    @Test(priority = 3)
    public void testUpdateUser() {
        ...
        Response response = User_endpoints2.update_User(this.user_payload,this.user_payload.getUsername());
        response.then().log().all();
        Assert.assertEquals(response.getStatusCode(), 200);
    }
    @Test(priority = 4)
    public void testDeleteUser() {
        ...
        Response response = User_endpoints2.delete_User(this.user_payload.getUsername());
        response.then().log().all();
        Assert.assertEquals(response.getStatusCode(), 200);
    }
}
